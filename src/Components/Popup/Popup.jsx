...
const Popup = ({ orderPopup, setOrderPopup }) => {
  return <>{orderPopup && <div className='popup'>
    ...
    backdrop-blur-sm'>
      ...
      duration-200 w-[300px]'>
        ...
        <div className='mt-4'>
          ...
          rounded-full border border-gray-300 dark:border-gray-500 dark:bg-gray-800 px-2
          py-1 mb-4'/>
        </div>
        <div className='mt-4'>
        ...
        <div className='mt-4'>
          ...
          hover:scale-105 duration-200 text-while
          py-6 px-4 rounded-full'></div>
        </div>
      </div>
    </div>
  </div>
